<%@ Page Language="C#" AutoEventWireup="true" CodeFile="proj_all_select.aspx.cs" Inherits="admin_proj_all_select" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:GridView ID="g1" Width="100%"   HorizontalAlign="Center" runat="server" CellPadding="3" GridLines="Horizontal" AutoGenerateColumns="False" BackColor="White" BorderColor="#E7E7FF" BorderStyle="None" BorderWidth="1px" >
            <AlternatingRowStyle BackColor="#F7F7F7" />
            <Columns>
                <asp:BoundField DataField="课题名称" HeaderText="课题名称" ItemStyle-HorizontalAlign="Center" />
                ...
                <asp:BoundField DataField="老师姓名" HeaderText="老师姓名" ItemStyle-HorizontalAlign="Center"/>
