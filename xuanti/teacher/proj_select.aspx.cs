...
public partial class teacher_proj_select : System.Web.UI.Page
{
    ...
    protected void bind()
    {
        ...
        String sql = "select * from proj_info where tea_id='"+user+"'";
...

    {
        if (proj_no.Text.Trim() != "")
        {
            ...
            String sql = "select * from proj_info where tea_id='"+user+"'"+" and proj_id='" + proj_no1+"'";
            Response.Write(sql);
